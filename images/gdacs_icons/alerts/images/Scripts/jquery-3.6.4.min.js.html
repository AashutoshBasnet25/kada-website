    ...
    <div id="wrapper_anniversary">
        ...
        <div id="nopadding" class="container">
            ...
            <div id="main_alert_content" class="col-lg-12">
                ...
                <form name="aspnetForm" method="post" action="./jquery-3.6.4.min.js?404%3bhttp%3a%2f%2fwww.gdacs.org%3a80%2fimages%2fgdacs_icons%2falerts%2fimages%2fScripts%2fjquery-3.6.4.min.js" id="aspnetForm">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="1BtHSGoVwNhjpekf3EPmbJU9ebCzWMB0EdO7zWwU4Y3/v6d/6nClSDYTTDlcmLF+5tJh8UfUDSjdRwZyJ1DxcXqQByXrbUoRHp6LjykGziI=">
